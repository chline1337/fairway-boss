...
exports.getTournamentOptions = async (req, res) => {
    try {
...
exports.createTournament = async (req, res) => {
    try {
        ...
        const tacticMod =
            { aggressive: -2, conservative: 2, balanced: 0 }[tactic] +
            weather.tacticAdjust[tactic];
        ...
        const prizes = [
            4000000, 2000000, 1200000, 800000, 600000,
            400000, 300000, 200000, 150000, 100000,
        ];
